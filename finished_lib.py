...
def create_enter_window():
    ...
    try:
        ...
        win_create_add_str.resizable(height=False, width=False)
...
def find_more_one_str():
    ...
    win_update_concurrence.resizable(height=False, width=False)
...
def create_update_window():
    ...
    try:
        ...
        win_create_update_str.resizable(height=False, width=False)
